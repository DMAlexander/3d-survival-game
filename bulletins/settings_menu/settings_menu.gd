...
func _ready() -> void:
	...
	sfx_volume_sldier.value_changed.connect(_on_sfx_volume_slider_value_changed)
	...
	fullscreen_check_button.toggle.connect(_on_fullscreen_check_button_toggled)
...
func set_settings_visuals(settings_resource: SettingsResource) -> void:
	...
	full_check_button.button_pressed = settings_resource.fullscreen_enabled
...
func _on_ssaa_check_button_toggled(toggled_on: bool) -> void:
	EventSystem.SFX_play_sfx.emit(SFXConfig.Keys.UICheck)
