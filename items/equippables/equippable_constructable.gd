...
@onready var constrcutable_area_collision_shape: CollisionShape3D = $ConstructableArea/CollisionShape3D
...
func _ready() -> void:
	...
	constructable_preview_mesh.mesh = $MeshHodler.get_child(0).mesh_duplciate()
